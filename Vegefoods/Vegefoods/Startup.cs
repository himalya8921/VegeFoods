...
namespace Vegefoods
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<VegeFoodsEntities.Entities.VegeDbContext>(options =>
     options.UseSqlServer(Configuration.GetConnectionString("VegeFoodDbEntities")));
            ...
            services.AddScoped<IVegeBusinessAccess, VegeBusinessAccess>();
            services.AddScoped<IVegeDataAccess, VegeDataAccess>();
        }
